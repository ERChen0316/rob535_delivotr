...
# DEBUG CONFIG - Very permissive thresholds to see ANY detections
...
model = dict(
    ...
    bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            max_num=500,
            score_threshold=0.001,  # VERY LOW - almost no filtering
            out_size_factor=1,
    ...
    test_cfg=dict(
        ...
        pre_max_size=4096,
        post_max_size=500,
        nms_thr=0.01  # VERY LOW - keep almost everything
    )
)
